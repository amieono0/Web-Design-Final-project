...
function makePatientCard() {
  let p = {
    ...
    name: $("pName")?.value || "Mohamed Kamara",
    age: $("pAge")?.value || "28",
    blood: $("pBlood")?.value || "O+",
    phone: $("pPhone")?.value || "+232 76 123456",
    address: $("pAddress")?.value || "Freetown",
    photo: selectedPhoto,
  };
  patients.unshift(p);
  save();
  ...
  renderPatients();
  if ($("cardResult")) $("cardResult").innerHTML = patientCardHTML(p);
  toast("Patient card generated");
}
